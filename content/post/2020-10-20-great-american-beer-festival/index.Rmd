...
This week, we explore which beer styles and categories are over/under represented in the Great American Beer Festival winners.
...
Only Pale Ale, Specialty Beers, and recently, Wild/Sour Beers are the only `beer styles` which are differentiable in terms of beer medal awarded from the rest.
...
```
Only California, and Colorado are the only `states` which are differentiable in terms of beer medal awarded from the rest.
